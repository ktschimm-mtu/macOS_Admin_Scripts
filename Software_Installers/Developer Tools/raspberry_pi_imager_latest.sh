...
executionName="rpi-imager"

###################################
## Logging Setup
###################################
logDir="/Library/Logs/Install/"
logFile="/Library/Logs/Install/Raspberry Pi Imager.log"
...
/usr/bin/curl -sL -o "/tmp/${appName}/${appName}.dmg" "https://downloads.raspberrypi.org/imager/imager_latest.dmg"
