...
logFile="/Library/Logs/Install/Grammarly.log"
...
/usr/bin/curl -sL -o "/tmp/${appName}/${appName}.dmg" "https://download-editor.grammarly.com/osx/${appName}.dmg"
