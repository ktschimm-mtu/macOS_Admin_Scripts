...
logFile="/Library/Logs/Install/Google Drive.log"
...
/usr/bin/curl -sL -o "/tmp/${appName}/${appName}.dmg" "https://dl.google.com/drive-file-stream/GoogleDrive.dmg"
...
/usr/sbin/installer -pkg "${diskImage}/${pkgName}.pkg" -target "/Applications/" >/dev/null 2>&1
